...
func (s *ProjectService) invitePM(ctx context.Context, exec db.Executor, workspaceID, projectID, email, actorID, actorRole, inviterName, inviteeName string) error {
