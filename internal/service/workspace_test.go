...
func (f *fakeInvitationCreator) CreateInvitation(_ context.Context, _ db.Executor, email, workspaceID, role, _, _, _, _, _, displayName string, _ bool) (*Invitation, error) {
	if f.err != nil {
		return nil, f.err
	}
